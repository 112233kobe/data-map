if($(window).width() > 991) {
	...
	document.getElementById("title").style.height = total * 0.15 + "px";
	...
	document.getElementById("box8-box").style.height = main_h * 0.475 + "px";
	box02.style.height = main_h * 0.62 + "px";
	document.getElementById("box9-box").style.height = main_h * 0.40 + "px";
	box03.style.height = main_h * 0.565+ "px";
	box04.style.height = main_h * 0.565 + "px";
	...
	document.getElementById("total-mn2").style.height = box01_h * 0.01 + "px";
...
app.controller('customersCtrl', function($scope, $http) {
	$http({
		...
		var resizeWorldMapContainer2 = function() {
			...
			worldMapContainer2.style.height = box01_h * 0.35 + 'px';
		};
		//设置容器高宽
		...
		var resizeWorldMapContainer4 = function() {
			worldMapContainer4.style.width = box01_w * 0.95 + 'px';
			worldMapContainer4.style.height = box01_h * 0.38 + 'px';
		};
		//设置容器高宽
